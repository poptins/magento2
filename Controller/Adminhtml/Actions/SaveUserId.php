...
class SaveUserId extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $this->configHelper->setPoptinClientId($data['poptin_user_id']);
        $this->messageManager->addSuccessMessage(__("Poptin was successfully installed  on your site"));
